...
<p style="margin:0;font-family:Arial,Helvetica,sans-serif;color:#333333;font-size:20px;font-weight:400;text-transform:uppercase">Thông báo từ BQT {{ config('id.name.portal') }} US</p>
</td>
</tr>
<tr>
<td height="30">
...
<tr>
<td height="30">
<p style="margin:0;font-family:Arial,Helvetica,sans-serif;color:#555;font-size:13px">Bạn vừa gửi yêu cầu xác thực email trên <strong>{{ config('id.name.site') }}</strong>.</p>
</td>
</tr>
<tr>
<td height="30">
...
<tr>
<td height="60">
<p style="margin:0;font-family:Arial,Helvetica,sans-serif;font-size:13px">{{ route('email-verify', [ 'token' => $token ])}}</p>
</td>
</tr>
<tr>
<td height="30">
